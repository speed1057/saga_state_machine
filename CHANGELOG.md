...
- Added a Contributors section to the README to acknowledge community contributions
- Credited [@lucaslannes](https://github.com/lucaslannes) for code and tests in the README contributor list
